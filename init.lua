...
-- [[ Setting options ]]
-- Affichage des nombres sur la gauche
vim.o.number = true
...
-- :Lazy
-- Il est possible de faire :help nom-plugin pour avoir de la doc en plus
-- event = 'VimEnter' loads plugin before all the UI elements are loaded.
...
require('lazy').setup({
        ...
        callback = function(event)
          ...
          local function client_supports_method(client, method, bufnr)
            if vim.fn.has 'nvim-0.11' == 1 then
              ...
              -- NOTE: Ignorer le warning car je suis en 0.11
          ...
          -- Creates a keymap to toggle inlay hints in code
  ...
  -- TODO: separate plugins like this files
